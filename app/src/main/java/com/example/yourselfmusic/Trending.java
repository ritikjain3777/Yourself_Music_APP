...
public class Trending {
    ...
    public Trending(String status_artist, String status_name, String status_thumbnail, String status_timestamp, String status_download_link, String status_video_url) {
